#!/usr/bin/env python3
"""Generate a ProofRail Bronze Claim Schema v0.1.1 YAML file.

Usage:
  python3 tools/claims/generate_bronze_claim_v0_1_1.py <package-root>
  python3 tools/claims/generate_bronze_claim_v0_1_1.py <package-root> --output <path>

The package root must contain:
  claim-input-v0.1.1.yaml

This tool performs deterministic claim assembly and light evidence-path checks.
It does not certify production conformance.
"""
...
INPUT_NAME = "claim-input-v0.1.1.yaml"
...
def main() -> int:
    ...
    parser.add_argument("package_root", help="Evidence package or demo root containing claim-input-v0.1.1.yaml")
    ...
    claim: dict[str, Any] = {
        "spec_version": claim_meta.get("spec_version", "v0.1.1"),
        ...
        "validation": {
            ...
            "validator": validation.get("validator", "ProofRail Bronze claim validator v0.1.1 structural check"),
            "generated_at": now,
